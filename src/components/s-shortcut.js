...
// @element s-shortcut
export default class SShortcut extends HTMLElement {
  ...
  constructor() {
    ...
    this.#shadowRoot.adoptedStyleSheets = [SShortcut.#shadowStyleSheet];
    this.#shadowRoot.append(
      document.importNode(SShortcut.#shadowTemplate.content, true)
    );
...
customElements.define("s-shortcut", SShortcut);
