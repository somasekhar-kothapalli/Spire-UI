...
// @element s-backdrop
export default class SBackdrop extends HTMLElement {
  ...
  constructor() {
    ...
    this.#shadowRoot.adoptedStyleSheets = [SBackdrop.#shadowStyleSheet];
  ...
  connectedCallback() {
    this.addEventListener(
      "wheel",
      (this.#wheelListener = (event) => event.preventDefault())
    );
  }
...
customElements.define("s-backdrop", SBackdrop);
