...
// @part input
export default class SInput extends HTMLElement {
  ...
  static #shadowStyleSheet = css`
    ...
    #input:-internal-autofill-selected {
      -webkit-box-shadow: var(--autofill-background-color) 0px 0px 0px 30px
        inset;
    }
  ...
  constructor() {
    ...
    this.#shadowRoot.adoptedStyleSheets = [SInput.#shadowStyleSheet];
    this.#shadowRoot.append(
      document.importNode(SInput.#shadowTemplate.content, true)
    );
