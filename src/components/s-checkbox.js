...
export default class SCheckbox extends HTMLElement {
  ...
  constructor() {
    ...
    this.#shadowRoot.adoptedStyleSheets = [SCheckbox.#shadowStyleSheet];
    this.#shadowRoot.append(
      document.importNode(SCheckbox.#shadowTemplate.content, true)
    );
  ...
  async connectedCallback() {
    Spire.addEventListener(
      "themechange",
      (this.#xelThemeChangeListener = () => this.#updateCheckmarkPathData())
    );
  ...
  #updateCheckmarkPathData() {
    let pathData = getComputedStyle(this["#indicator"]).getPropertyValue(
      "--path-data"
    );
