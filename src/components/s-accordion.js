...
export default class SAccordion extends HTMLElement {
  ...
  constructor() {
    ...
    this.#shadowRoot.adoptedStyleSheets = [SAccordion.#shadowStyleSheet];
    this.#shadowRoot.append(
      document.importNode(SAccordion.#shadowTemplate.content, true)
    );
  ...
  async connectedCallback() {
    await Spire.whenThemeReady;

    this.#headerResizeObserver = new ResizeObserver(() =>
      this.#onHeaderResize()
    );
    this.#childListMutationObserver = new MutationObserver((args) =>
      this.#onChildListChange(args)
    );
...
customElements.define("s-accordion", SAccordion);
