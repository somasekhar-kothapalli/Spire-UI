...
// @element s-tooltip
export default class STooltip extends HTMLElement {
  ...
  constructor() {
    ...
    this.#shadowRoot.adoptedStyleSheets = [STooltip.#shadowStyleSheet];
    this.#shadowRoot.append(
      document.importNode(STooltip.#shadowTemplate.content, true)
    );
...
customElements.define("s-tooltip", STooltip);
