...
export default class XTab extends HTMLElement {
  ...
  constructor() {
    ...
    this.#shadowRoot.adoptedStyleSheets = [XTab.#shadowStyleSheet];
    this.#shadowRoot.append(
      document.importNode(XTab.#shadowTemplate.content, true)
    );
...
customElements.define("s-tab", XTab);
