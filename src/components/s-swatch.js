...
// @element s-swatch
export default class SSwatch extends HTMLElement {
  ...
  constructor() {
    ...
    this.#shadowRoot.adoptedStyleSheets = [SSwatch.#shadowStyleSheet];
    this.#shadowRoot.append(
      document.importNode(SSwatch.#shadowTemplate.content, true)
    );
...
customElements.define("s-swatch", SSwatch);
