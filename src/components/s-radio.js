...
export default class SRadio extends HTMLElement {
  ...
  constructor() {
    ...
    this.#shadowRoot.adoptedStyleSheets = [SRadio.#shadowStyleSheet];
    this.#shadowRoot.append(
      document.importNode(SRadio.#shadowTemplate.content, true)
    );
